...
const yeuCau6 = async () => {
    return await prisma.product.findMany({
        where: {
            OR: [
                { price: { gte: 10000000, lte: 15000000 } }, // 10 trieu - 15 trieu
                { price: { gte: 16000000, lte: 20000000 } } // 16 trieu - 20 trieu
            ]
        }
    })
}
...
export {
    userFilter, yeuCau1, yeuCau2, yeuCau3,
    yeuCau4, yeuCau5, yeuCau6, yeuCau7, getProductWithFilter
}