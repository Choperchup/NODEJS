...
const addProductToCart = async (quantity: number, productId: number, user: Express.User) => {
    ...
    if (cart) {
        ...
        // cap nhat cartdetail
        // Neu chua co, tao moi. Neu co roi, cap nhat quantity
        // update + insert
...
const getProducInCart = async (userId: number) => {
    const cart = await prisma.cart.findUnique({
        where: { userId }
    })
...
export {
    ...
    getProducInCart, deleteProductInCart,
    updateCartDetailBeforeCheckout, handlePlaceOrder,
