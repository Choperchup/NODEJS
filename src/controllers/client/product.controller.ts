...
import {
    addProductToCart, deleteProductInCart, getOrderHistory, getProducInCart,
    getProductById, handlePlaceOrder, updateCartDetailBeforeCheckout
...
const getCartPage = async (req: Request, res: Response) => {
    ...
    const cartDetails = await getProducInCart(+user.id);
...
export {
    ...
    getCartPage, postDeleteProductInCart, getCheckOutPage,
    postHandleCartToCheckOut, postPlaceOrder, getThankYouPage,
